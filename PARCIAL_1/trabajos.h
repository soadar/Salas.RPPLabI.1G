...
void informeTrabajosXMes (Trabajo* listT, int tamT, Mascota* listM, int tamM, Servicio* listS, int tamS, Tipo* listTipo, int tamTipo, Color* listColor, int tamC, int checkT);
